    ...
    <div className="p-4 rounded-[8px] border-[1px] border-[#E5E7EB] bg-[#F9FAFB]">
      <div className="flex flex-col gap-5 items-center">
        <div className="flex flex-col items-center text-[12px]">
          <Image src={`${process.env.NEXT_PUBLIC_BASE_PATH}/icons/app_icon.svg`} width={32} height={32} alt="" />
        ...
        <div className="flex justify-between items-center gap-3">
          <div className="bg-[#E5E7EB] rounded-[8px] gap-3 p-2 flex items-center">
            <Image src={`${process.env.NEXT_PUBLIC_BASE_PATH}/icons/apple.svg`} width={26} height={26} alt="" />
          ...
          <div className="bg-[#E5E7EB] rounded-[8px] gap-3 p-2 flex items-center">
            <Image
              src={`${process.env.NEXT_PUBLIC_BASE_PATH}/icons/googleplay.svg`}
              width={26}
              height={26}
              alt=""
            />
