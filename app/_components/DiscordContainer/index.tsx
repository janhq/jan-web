...
const DiscordContainer = () => (
  <div className="border-t border-gray-200 p-3 gap-3 flex items-center justify-between">
    ...
    >
      <Image
        src={`${process.env.NEXT_PUBLIC_BASE_PATH}/icons/ico_mobile-android.svg`}
        width={16}
        height={16}
        alt=""
      />
    ...
    <Link
      ...
      target="_blank_"
    >
      <Image src={`${process.env.NEXT_PUBLIC_BASE_PATH}/icons/ico_Discord.svg`} width={20} height={20} alt="" />
      Discord
    </Link>
  </div>
);
